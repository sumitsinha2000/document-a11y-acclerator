"""
Helpers for annotating issues with WCAG 2.1 success criterion details.
"""
...
WCAG_CRITERIA_DETAILS: Dict[str, Dict[str, str]] = {
    "1.1.1": {
        ...
        "level": "A",
        "summary": "Provide text alternatives for images, figures, and other non-text content.",
    },
    "1.3.1": {
        "name": "Info and Relationships",
        "level": "A",
        "summary": "Preserve semantic structure so assistive tech can perceive relationships.",
    },
    "1.3.2": {
        "name": "Meaningful Sequence",
        "level": "A",
        "summary": "Ensure the reading order conveys the intended meaning.",
    },
    "1.4.3": {
        "name": "Contrast (Minimum)",
        "level": "AA",
        "summary": "Text/background contrast must be at least 4.5:1 for normal text.",
    },
    "1.4.6": {
        "name": "Contrast (Enhanced)",
        "level": "AAA",
        "summary": "Enhanced contrast of 7:1 provides better readability.",
    },
    "2.4.2": {
        "name": "Page Titled",
        "level": "A",
        "summary": "Provide descriptive titles so users can identify documents.",
    },
    "2.4.6": {
        "name": "Headings and Labels",
        "level": "AA",
        "summary": "Use descriptive headings/labels to aid navigation.",
    },
    "3.1.1": {
    ...
    "3.3.2": {
        ...
        "level": "A",
        "summary": "Provide labels so users know what input is required.",
    },
    "4.1.2": {
        "name": "Name, Role, Value",
        "level": "A",
        "summary": "Expose UI element semantics programmatically.",
    },
}
...
def _format_criteria_list(criteria: Iterable[str]) -> str:
    ...
    formatted = [
        item for code in criteria if (item := _format_single_criterion(code))
    ]
...
def annotate_wcag_mappings(results: Any) -> Any:
    """
    Ensure every issue list contains human-friendly WCAG mapping metadata.

    Args:
        results: Dictionary of categorized issues (results from analyzer)

    Returns:
        The same structure with a wcagCriteria string added where applicable.
    """
