...
export const API_ENDPOINTS = {
  ...
  projectNames: `${API_BASE_URL}/api/groups/names`,
  projectFolderCount: (projectId: string) => `${API_BASE_URL}/api/groups/${projectId}/folder-count`,
  projectDetails: (projectId: string) => `${API_BASE_URL}/api/groups/${projectId}`,
  folders: `${API_BASE_URL}/api/folders`,
  folderDetails: (folderId: string) => `${API_BASE_URL}/api/folders/${folderId}/details`,
