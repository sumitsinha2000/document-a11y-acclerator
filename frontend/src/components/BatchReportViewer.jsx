          ...
          <div className="flex-1 overflow-y-auto p-2">
            {scansState.map((scan) => (
              <button
                ...
                title={`View details for ${scan.filename}${scan.scanId ? ` (ID: ${scan.scanId})` : ""}`}
              >
                <div className="font-semibold truncate text-base">{scan.filename}</div>
                {scan.scanId && (
                  <div className="text-xs text-gray-500 dark:text-gray-400 mt-1 truncate">{scan.scanId}</div>
                )}
              </button>
            ))}
          </div>
      ...
      <div className="bg-white dark:bg-slate-800 border-b-2 border-slate-200 dark:border-slate-700 rounded-xl py-8 px-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" role="img" aria-label="Back">
                        ...
                        <td className="px-7 py-5">
                          <div className="flex items-center gap-3">
                            <input
                              type="checkbox"
                              className="w-4 h-4 rounded border-gray-300"
                              aria-label={`Select ${scan.filename}`}
                            />
                            <div>
                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            {isUploaded ? (
                              ...
                              <button
                                ...
                                className="px-5 py-2.5 text-base font-semibold text-emerald-700 dark:text-emerald-300 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                title="Fix Issues"
                              >
