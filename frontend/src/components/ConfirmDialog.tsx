...
import type { ConfirmDialogProps as NotificationConfirmDialogProps } from '../contexts/NotificationContext';

type ConfirmDialogProps = NotificationConfirmDialogProps;
