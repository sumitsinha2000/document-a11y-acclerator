...
export default function FixSuggestions({ scanId, fixes, filename, onRefresh }) {
  ...
  const sanitizedScanId = String(scanId ?? "scan").replace(/[^a-zA-Z0-9-_]/g, "-")
  const tooltipId = (key) => `${key}-${sanitizedScanId}`
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="relative inline-flex group">
            <button
              ...
              disabled
              aria-disabled="true"
              aria-describedby={tooltipId("ai-insights-tooltip")}
            ...
            <span
              id={tooltipId("ai-insights-tooltip")}
              role="tooltip"
            ...
            >
              AI-powered remediation insights are currently unavailable
            </span>
          </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4" role="region" aria-label="Fix suggestions by type">
        ...
        {hasSemiAutomated && (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700 flex flex-col">
            ...
            <div className="space-y-2 mt-auto">
              <span className="relative w-full group inline-flex">
                <button
                  ...
                  aria-disabled="true"
                  aria-describedby={tooltipId("semi-automated-tooltip")}
                ...
                <span
                  ...
                  className="pointer-events-none absolute left-1/2 bottom-full mb-2 -translate-x-1/2 whitespace-nowrap rounded-md bg-black px-3 py-1 text-lg font-medium text-white opacity-0 shadow-lg transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100"
                >
                  Semi-automated remediation is currently unavailable
                </span>
              </span>
